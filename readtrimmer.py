...
def parserfunc():
    ...
    args = my_parser.parse_args("-f BRISCOE_0069_BD18RUACXX_L2_1_pf.fastq.txt BRISCOE_0069_BD18RUACXX_L2_2_pf.fastq ".split())
    ...
    try:
        ...
        for line in map(list,zip(fastq[0],fastq[num])):
            ...
            if len(read) == len(start.files)*2:   
                ...
                #trims quality line based in length of trim
